...
dplyr::filter(which_phase == 2) |> # Finally estimates from  PHASE 2
...
make_summary_table() |>
knitr::kable(caption = "10 year average") |>
...
results_all |>
dplyr::filter(period == "6_10") |>
make_summary_table() |>
 knitr::kable(caption = "6 - 10 years") |>
    kableExtra::kable_styling(font_size = 18)
```
